...
|Tip|Why?|
|-------------------------------------------|-------------------------------------------------------|
|✔ **DO** refer to  the [What to disclose](#what-to-disclose) section of this article when deciding what information to include|Shoppers tend to have a common set of questions and concerns about how personal data is used and protected.|
