...
You can use customizable skill zones in Microsoft Dynamics 365 Connected Spaces Preview to have your camera collect physical data based on the needs of your store. You can add or update your skill zones at any time using the mobile app.
