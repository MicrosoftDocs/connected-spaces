...
The Connected Store table of contents is organized to make it easy to get up and running quickly with all the hardware and software described above. When you're ready to sign up for the public preview and install the software, start with the first article in the Setup section:
