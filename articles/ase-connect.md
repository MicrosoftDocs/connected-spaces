...
2. In the **Network** screen:
   ...
   b. In the **Network settings** pane on the right side of the screen, **DHCP** should be selected by default. If DHCP is enabled in your environment, network interfaces are automatically configured, including an IP address, subnet, gateway, and DNS. 
