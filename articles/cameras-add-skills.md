...
3. Select the appropriate camera for the skill, and then select **Next**. 
    ...
    > [!NOTE]
    > If you don't see any cameras in this screen, you need to [connect your cameras to a gateway](cameras-connect-gateway.md) before adding skills.
...
4. Draw a skill area to track customer behavior.
    ...
    > [!TIP]
    > If you need to start over at any point when drawing a skill zone, select **Reset**. See also [Tips for drawing skill areas](). 
